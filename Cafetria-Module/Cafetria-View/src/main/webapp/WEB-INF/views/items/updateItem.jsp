...
<div class="box box-primary" dir="${dir}">
    <div class="box-header with-border">
        <h3 class="box-title"><spring:message code="item.update" text="default text" /></h3>
    </div>
    <form:form class="form-horizontal" method="post"  action="updateItem" commandName="item" enctype="multipart/form-data">
        <!--                    </div>-->
        <div class="box-body">
            <!-- text feild -->
           ...
           <!--displayimage-->
             ...
             <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label ${cssClasses[0]}"><spring:message code="item.image" text="default text" /></label>

                <div class="col-sm-5 ${cssClasses[1]}">
                   
                    <img src="/Cafetria/photo/img${item.id}" width="200" height="150" alt="no image"/> 
                   <h6><spring:message code="item.change" text="default text" /></h6>
           ...
           <!--end displayimage-->
            ...
            <div class="box-footer">
                ...
                <a href="showItem" class="btn btn-default" ><spring:message code="item.cancel" text="cancel" /></a>
            </div>
