...
<div class="box box-primary" dir="${dir}">
    <div class="box-header with-border">
        <h3 class="box-title"><spring:message code="customer.add" text="default text" /> </h3>
    </div>
        <form:form method="post" commandName="customer" class="form-horizontal" action="addCustomer">
        <div class="box-body">
