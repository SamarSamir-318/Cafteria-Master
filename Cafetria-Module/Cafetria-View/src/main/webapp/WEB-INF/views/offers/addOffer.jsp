...
<div class="box box-primary" dir="${dir}">
    <div class="box-header with-border">
        <h3 class="box-title"><spring:message code="offer.add" text="default text" /></h3>
    </div>
    <!-- /.box-header -->
    <!-- form start -->
    <form:form class="form-horizontal" method="post"  action="addOffer"   commandName="offer">
        <div class="box-body">
            <!--description-->
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5 ${cssClasses[1]}">
                    <form:input path="discountPercentage"  type=" number" class="form-control" id="inputEmail3" placeholder="description"/>
                </div>
