...
<div class="box box-primary" dir="${dir}">
    <div class="box-header with-border">
        <h3 class="box-title"><spring:message code="privilege.add" text="default text" /></h3>
    </div>
    <!-- /.box-header -->
    <!-- form start -->
    <form:form class="form-horizontal" method="post" action="addPrivilege"  commandName="privilege">
        <div class="box-body">
            <div class="form-group" >
                <label for="name" class="col-sm-2 control-label ${cssClasses[0]}"><spring:message code="privilege.name" text="Name" /></label>
