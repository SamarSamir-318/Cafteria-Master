...
<display:table id="item" name="allItems" requestURI="${tableURL}" 
    ...
    <display:column sortable="true" property="id" sortName="id" style="width:20%;"/>
    ...
    <display:column href="${editURL}" paramId="id" paramProperty="id"  style="text-align:center;width:5%;"  titleKey="category.update">  
        <%--<spring:message code="category.update" text="Update" />--%>
    </display:column>
    <display:column href="${deleteURL}" paramId="id" paramProperty="id"  style="text-align:center;width:5%;"  titleKey="category.delete">  
    </display:column>
