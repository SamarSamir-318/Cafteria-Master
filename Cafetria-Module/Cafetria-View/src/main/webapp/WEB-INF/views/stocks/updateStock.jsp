<%-- 
    ...
    Created on : May 28, 2017, 10:45:51 AM
    Author     : Masoud
--%>
...
<div class="box box-primary" dir="${dir}">
    <div class="box-header with-border">
        <h3 class="box-title"><spring:message code="stock.editPage" text="default text" /> </h3>
    </div>
    <form:form method="post" commandName="stock" class="form-horizontal">
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5 ${cssClasses[1]}">
                    <form:select path="cafetria.id" class="form-control" >
                        <c:forEach var="cafetria" items="${cafetrias}">
                            <form:option value="${cafetria.id}">
                                <c:out value="${cafetria.name}"  />
                            </form:option>
                        </c:forEach>
                    </form:select>
                </div>
            ...
            <div class="box-footer">
                <input type="submit" class="btn btn-primary pull-default" value=<spring:message code="stock.save" text="default text" />>
