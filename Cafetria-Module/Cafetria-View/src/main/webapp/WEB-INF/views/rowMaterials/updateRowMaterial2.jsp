<%-- 
    Document   : updateRowMaterial2
    Created on : Jun 19, 2017, 2:19:09 AM
    Author     : Masoud
--%>
...
<div class="box box-primary" dir="${dir}">
    ...
    <form:form method="post" commandName="rowMaterial" action="updateRowMaterial2" class="form-horizontal">
        <div class="box-body">
