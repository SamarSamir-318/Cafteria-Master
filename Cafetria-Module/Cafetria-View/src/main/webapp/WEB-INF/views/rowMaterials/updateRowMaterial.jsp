<%-- 
    Document   : updateRowMaterial
    Created on : May 28, 2017, 11:00:37 AM
    Author     : Masoud
--%>
...
<div class="box box-primary" dir="${dir}">
    ...
    <form:form method="post" commandName="rowMaterial" action="updateRowMaterial"  class="form-horizontal">
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label ${cssClasses[0]}"> 
                        Quantity in ${stock.location} Stock
                    </label>
                    <div class="col-sm-5 ${cssClasses[1]}">
