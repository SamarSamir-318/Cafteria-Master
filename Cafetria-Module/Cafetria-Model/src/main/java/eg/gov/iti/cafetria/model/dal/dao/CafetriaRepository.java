 ...
 */
@Repository
public interface CafetriaRepository extends ITICRUDRepository<Cafetria, Integer> {

    @Query("select c from Cafetria c where c.name = ?")
    public Cafetria findByName(String name);
}
